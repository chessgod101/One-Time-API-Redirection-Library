...
PUSH EAX //VOLITLE REGISTER PRESERVATION SUPPORT FOR REGISTER BASED CALLS OR FASTCALL CONVENTIONS
...
@DoneUnloadSetup:
PUSH EBX //VOLITLE REGISTER PRESERVATION SUPPORT FOR REGISTER BASED CALLS OR FASTCALL CONVENTIONS
PUSH ECX
PUSH EDX
PUSH EAX
CALL DoYourStuff
